...
const routes = [
  { path: '/', name: '供给工作台', component: Home },
  { path: '/supplier', name: '供应商', component: Supplier },
  { path: '/product', name: '供应商产品', component: Product },
  { path: '/brand', name: '品牌管理', component: Brand },
  { path: '/store', name: '门店管理', component: Store },
  { path: '/goods', name: '标准商品', component: Goods },
  { path: '/spec', name: '商品规格', component: Spec },
  { path: '/category', name: '分类管理', component: Category },
  { path: '/order', name: '履约订单', component: Order },
  { path: '/application', name: '应用管理', component: Application },
  { path: '/settings', name: '系统概览', component: Settings },
